...
const EVENTS = [
  {
    ...
    type: 'work',
    title: '1stplace',
    subtitle: 'agencja SEO + AI',
    role: 'n8n Developer',
    period: 'Listopad 2025 — obecnie',
    duration: 'aktualnie',
    location: 'Poznań · hybrydowo',
    current: true,
    description: 'Buduję od podstaw system automatyzacji procesów contentowych agencji. Workflow w n8n z integracjami AI: generowanie treści, lead generation, web scraping, przetwarzanie danych przez modele językowe.',
    tags: ['n8n', 'Claude API', 'OpenRouter', 'Web Scraping', 'CRM'],
  },
  {
    id: 'studia',
    type: 'edu',
